...
SET tableId = 5, name = "Object",
	...
	INSERT INTO md_Column
	SET columnId = 139, tableId = 5, name = "earliestObsT",
		type = "DATETIME",
		notNull = 0,
		displayOrder = 4;

	INSERT INTO md_Column
	SET columnId = 140, tableId = 5, name = "latestObsT",
		type = "DATETIME",
		notNull = 0,
		displayOrder = 5;

	INSERT INTO md_Column
	SET columnId = 141, tableId = 5, name = "uMag",
	...
	INSERT INTO md_Column
	SET columnId = 142, tableId = 5, name = "uMagErr",
	...
	INSERT INTO md_Column
	SET columnId = 143, tableId = 5, name = "uPetroMag",
	...
	INSERT INTO md_Column
	SET columnId = 144, tableId = 5, name = "uPetroMagErr",
	...
	INSERT INTO md_Column
	SET columnId = 145, tableId = 5, name = "uIxx",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 10;

	INSERT INTO md_Column
	SET columnId = 146, tableId = 5, name = "uIyy",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 11;

	INSERT INTO md_Column
	SET columnId = 147, tableId = 5, name = "uIxy",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 12;

	INSERT INTO md_Column
	SET columnId = 148, tableId = 5, name = "uNumObs",
	...
	INSERT INTO md_Column
	SET columnId = 149, tableId = 5, name = "uFlags",
		type = "INTEGER",
		notNull = 0,
		displayOrder = 14;

	INSERT INTO md_Column
	SET columnId = 150, tableId = 5, name = "gMag",
	...
	INSERT INTO md_Column
	SET columnId = 151, tableId = 5, name = "gMagErr",
	...
	INSERT INTO md_Column
	SET columnId = 152, tableId = 5, name = "gPetroMag",
	...
	INSERT INTO md_Column
	SET columnId = 153, tableId = 5, name = "gPetroMagErr",
	...
	INSERT INTO md_Column
	SET columnId = 154, tableId = 5, name = "gIxx",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 19;

	INSERT INTO md_Column
	SET columnId = 155, tableId = 5, name = "gIyy",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 20;

	INSERT INTO md_Column
	SET columnId = 156, tableId = 5, name = "gIxy",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 21;

	INSERT INTO md_Column
	SET columnId = 157, tableId = 5, name = "gNumObs",
		type = "INTEGER",
		notNull = 0,
		displayOrder = 22;

	INSERT INTO md_Column
	SET columnId = 158, tableId = 5, name = "gFlags",
		type = "INTEGER",
		notNull = 0,
		displayOrder = 23;

	INSERT INTO md_Column
	SET columnId = 159, tableId = 5, name = "rMag",
	...
	INSERT INTO md_Column
	SET columnId = 160, tableId = 5, name = "rMagErr",
	...
	INSERT INTO md_Column
	SET columnId = 161, tableId = 5, name = "rPetroMag",
	...
	INSERT INTO md_Column
	SET columnId = 162, tableId = 5, name = "rPetroMagErr",
	...
	INSERT INTO md_Column
	SET columnId = 163, tableId = 5, name = "rIxx",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 28;

	INSERT INTO md_Column
	SET columnId = 164, tableId = 5, name = "rIyy",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 29;

	INSERT INTO md_Column
	SET columnId = 165, tableId = 5, name = "rIxy",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 30;

	INSERT INTO md_Column
	SET columnId = 166, tableId = 5, name = "rNumObs",
		type = "INTEGER",
		notNull = 0,
		displayOrder = 31;

	INSERT INTO md_Column
	SET columnId = 167, tableId = 5, name = "rFlags",
		type = "INTEGER",
		notNull = 0,
		displayOrder = 32;

	INSERT INTO md_Column
	SET columnId = 168, tableId = 5, name = "iMag",
	...
	INSERT INTO md_Column
	SET columnId = 169, tableId = 5, name = "iMagErr",
	...
	INSERT INTO md_Column
	SET columnId = 170, tableId = 5, name = "iPetroMag",
	...
	INSERT INTO md_Column
	SET columnId = 171, tableId = 5, name = "iPetroMagErr",
	...
	INSERT INTO md_Column
	SET columnId = 172, tableId = 5, name = "iIxx",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 37;

	INSERT INTO md_Column
	SET columnId = 173, tableId = 5, name = "iIyy",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 38;

	INSERT INTO md_Column
	SET columnId = 174, tableId = 5, name = "iIxy",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 39;

	INSERT INTO md_Column
	SET columnId = 175, tableId = 5, name = "iNumObs",
		type = "INTEGER",
		notNull = 0,
		displayOrder = 40;

	INSERT INTO md_Column
	SET columnId = 176, tableId = 5, name = "iFlags",
		type = "INTEGER",
		notNull = 0,
		displayOrder = 41;

	INSERT INTO md_Column
	SET columnId = 177, tableId = 5, name = "zMag",
	...
	INSERT INTO md_Column
	SET columnId = 178, tableId = 5, name = "zMagErr",
	...
	INSERT INTO md_Column
	SET columnId = 179, tableId = 5, name = "zPetroMag",
	...
	INSERT INTO md_Column
	SET columnId = 180, tableId = 5, name = "zPetroMagErr",
	...
	INSERT INTO md_Column
	SET columnId = 181, tableId = 5, name = "zIxx",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 46;

	INSERT INTO md_Column
	SET columnId = 182, tableId = 5, name = "zIyy",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 47;

	INSERT INTO md_Column
	SET columnId = 183, tableId = 5, name = "zIxy",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 48;

	INSERT INTO md_Column
	SET columnId = 184, tableId = 5, name = "zNumObs",
		type = "INTEGER",
		notNull = 0,
		displayOrder = 49;

	INSERT INTO md_Column
	SET columnId = 185, tableId = 5, name = "zFlags",
		type = "INTEGER",
		notNull = 0,
		displayOrder = 50;

	INSERT INTO md_Column
	SET columnId = 186, tableId = 5, name = "yMag",
	...
	INSERT INTO md_Column
	SET columnId = 187, tableId = 5, name = "yMagErr",
	...
	INSERT INTO md_Column
	SET columnId = 188, tableId = 5, name = "yPetroMag",
	...
	INSERT INTO md_Column
	SET columnId = 189, tableId = 5, name = "yPetroMagErr",
	...
	INSERT INTO md_Column
	SET columnId = 190, tableId = 5, name = "yIxx",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 55;

	INSERT INTO md_Column
	SET columnId = 191, tableId = 5, name = "yIyy",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 56;

	INSERT INTO md_Column
	SET columnId = 192, tableId = 5, name = "yIxy",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 57;

	INSERT INTO md_Column
	SET columnId = 193, tableId = 5, name = "yNumObs",
		type = "INTEGER",
		notNull = 0,
		displayOrder = 58;

	INSERT INTO md_Column
	SET columnId = 194, tableId = 5, name = "yFlags",
		type = "INTEGER",
		notNull = 0,
		displayOrder = 59;
...
SET tableId = 6, name = "ObjectType",
	...
	INSERT INTO md_Column
	SET columnId = 195, tableId = 6, name = "typeId",
		description = "Unique id.",
		type = "SMALLINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 196, tableId = 6, name = "description",
		type = "VARCHAR(255)",
		notNull = 0,
		displayOrder = 2;
...
SET tableId = 7, name = "Raw_CCD_Exposure";
	...
	INSERT INTO md_Column
	SET columnId = 197, tableId = 7, name = "rawCCDExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 198, tableId = 7, name = "ccdDetectorId",
	...
	INSERT INTO md_Column
	SET columnId = 199, tableId = 7, name = "rawFPAExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 200, tableId = 7, name = "radecSys",
	...
	INSERT INTO md_Column
	SET columnId = 201, tableId = 7, name = "url",
	...
	INSERT INTO md_Column
	SET columnId = 202, tableId = 7, name = "ctype1",
	...
	INSERT INTO md_Column
	SET columnId = 203, tableId = 7, name = "ctype2",
	...
	INSERT INTO md_Column
	SET columnId = 204, tableId = 7, name = "crpix1",
	...
	INSERT INTO md_Column
	SET columnId = 205, tableId = 7, name = "crpix2",
	...
	INSERT INTO md_Column
	SET columnId = 206, tableId = 7, name = "crval1",
	...
	INSERT INTO md_Column
	SET columnId = 207, tableId = 7, name = "crval2",
	...
	INSERT INTO md_Column
	SET columnId = 208, tableId = 7, name = "cd11",
	...
	INSERT INTO md_Column
	SET columnId = 209, tableId = 7, name = "cd21",
	...
	INSERT INTO md_Column
	SET columnId = 210, tableId = 7, name = "cd12",
	...
	INSERT INTO md_Column
	SET columnId = 211, tableId = 7, name = "cd22",
	...
	INSERT INTO md_Column
	SET columnId = 212, tableId = 7, name = "taiObs",
	...
	INSERT INTO md_Column
	SET columnId = 213, tableId = 7, name = "darkTime",
	...
	INSERT INTO md_Column
	SET columnId = 214, tableId = 7, name = "zd",
...
SET tableId = 8, name = "Raw_FPA_Exposure";
	...
	INSERT INTO md_Column
	SET columnId = 215, tableId = 8, name = "rawFPAExposureId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 216, tableId = 8, name = "ra",
	...
	INSERT INTO md_Column
	SET columnId = 217, tableId = 8, name = "decl",
	...
	INSERT INTO md_Column
	SET columnId = 218, tableId = 8, name = "filterId",
		type = "INTEGER",
		notNull = 1,
		displayOrder = 4;

	INSERT INTO md_Column
	SET columnId = 219, tableId = 8, name = "equinox",
	...
	INSERT INTO md_Column
	SET columnId = 220, tableId = 8, name = "dateObs",
	...
	INSERT INTO md_Column
	SET columnId = 221, tableId = 8, name = "mjdObs",
	...
	INSERT INTO md_Column
	SET columnId = 222, tableId = 8, name = "expTime",
	...
	INSERT INTO md_Column
	SET columnId = 223, tableId = 8, name = "airmass",
...
SET tableId = 9, name = "Science_CCD_Exposure";
	...
	INSERT INTO md_Column
	SET columnId = 224, tableId = 9, name = "scienceCCDExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 225, tableId = 9, name = "scienceFPAExposureId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 2;

	INSERT INTO md_Column
	SET columnId = 226, tableId = 9, name = "rawCCDExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 227, tableId = 9, name = "ccdDetectorId",
	...
	INSERT INTO md_Column
	SET columnId = 228, tableId = 9, name = "filterId",
	...
	INSERT INTO md_Column
	SET columnId = 229, tableId = 9, name = "equinox",
		description = "Equinox of World Coordinate System.",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 6;
	...
	INSERT INTO md_Column
	SET columnId = 230, tableId = 9, name = "url",
	...
	INSERT INTO md_Column
	SET columnId = 231, tableId = 9, name = "ctype1",
		description = "Coordinate projection type, axis 1.",
		type = "VARCHAR(20)",
		notNull = 1,
		displayOrder = 8;
	...
	INSERT INTO md_Column
	SET columnId = 232, tableId = 9, name = "ctype2",
		description = "Coordinate projection type, axis 2.",
		type = "VARCHAR(20)",
		notNull = 1,
		displayOrder = 9;
	...
	INSERT INTO md_Column
	SET columnId = 233, tableId = 9, name = "crpix1",
		description = "Coordinate reference pixel, axis 1.",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 10;
	...
	INSERT INTO md_Column
	SET columnId = 234, tableId = 9, name = "crpix2",
		description = "Coordinate reference pixel, axis 2.",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 11;
	...
	INSERT INTO md_Column
	SET columnId = 235, tableId = 9, name = "crval1",
		description = "Coordinate value 1 @reference pixel.",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 12;
	...
	INSERT INTO md_Column
	SET columnId = 236, tableId = 9, name = "crval2",
		description = "Coordinate value 2 @reference pixel.",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 13;
	...
	INSERT INTO md_Column
	SET columnId = 237, tableId = 9, name = "cd1_1",
		description = "First derivative of coordinate 1 w.r.t. axis 1.",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 14;
	...
	INSERT INTO md_Column
	SET columnId = 238, tableId = 9, name = "cd2_1",
		description = "First derivative of coordinate 2 w.r.t. axis 1.",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 15;
	...
	INSERT INTO md_Column
	SET columnId = 239, tableId = 9, name = "cd1_2",
		description = "First derivative of coordinate 1 w.r.t. axis 2.",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 16;
	...
	INSERT INTO md_Column
	SET columnId = 240, tableId = 9, name = "cd2_2",
		description = "First derivative of coordinate 2 w.r.t. axis 2.",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 17;
	...
	INSERT INTO md_Column
	SET columnId = 241, tableId = 9, name = "dateObs",
		description = "Date/Time of observation start (UTC).",
		type = "TIMESTAMP",
		notNull = 1,
		defaultValue = "0",
	...
	INSERT INTO md_Column
	SET columnId = 242, tableId = 9, name = "expTime",
		description = "Duration of exposure.",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 19;
	...
	INSERT INTO md_Column
	SET columnId = 243, tableId = 9, name = "ccdSize",
	...
	INSERT INTO md_Column
	SET columnId = 244, tableId = 9, name = "photoFlam",
	...
	INSERT INTO md_Column
	SET columnId = 245, tableId = 9, name = "photoZP",
	...
	INSERT INTO md_Column
	SET columnId = 246, tableId = 9, name = "nCombine",
	...
	INSERT INTO md_Column
	SET columnId = 247, tableId = 9, name = "taiMjd",
	...
	INSERT INTO md_Column
	SET columnId = 248, tableId = 9, name = "bixX",
	...
	INSERT INTO md_Column
	SET columnId = 249, tableId = 9, name = "binY",
	...
	INSERT INTO md_Column
	SET columnId = 250, tableId = 9, name = "readNoise",
	...
	INSERT INTO md_Column
	SET columnId = 251, tableId = 9, name = "saturationLimit",
	...
	INSERT INTO md_Column
	SET columnId = 252, tableId = 9, name = "dataSection",
	...
	INSERT INTO md_Column
	SET columnId = 253, tableId = 9, name = "gain",
...
SET tableId = 10, name = "Science_FPA_Exposure";
	...
	INSERT INTO md_Column
	SET columnId = 254, tableId = 10, name = "scienceFPAExposureId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
...
SET tableId = 11, name = "Visit",
	...
	INSERT INTO md_Column
	SET columnId = 255, tableId = 11, name = "visitId",
		description = "Unique id.",
		type = "INTEGER",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 256, tableId = 11, name = "exposureId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 2;
...
SET tableId = 12, name = "_MovingObject2Type",
	...
	INSERT INTO md_Column
	SET columnId = 258, tableId = 12, name = "typeId",
	...
	INSERT INTO md_Column
	SET columnId = 259, tableId = 12, name = "probability",
...
SET tableId = 13, name = "_Object2Type",
	...
	INSERT INTO md_Column
	SET columnId = 261, tableId = 13, name = "typeId",
	...
	INSERT INTO md_Column
	SET columnId = 262, tableId = 13, name = "probability",
...
SET tableId = 14, name = "_Raw_FPA_Exposure2Visit",
	...
	INSERT INTO md_Column
	SET columnId = 264, tableId = 14, name = "exposureId",
...
SET tableId = 15, name = "_Science_FPA_Exposure2TemplateImage",
	...
	INSERT INTO md_Column
	SET columnId = 265, tableId = 15, name = "scienceFPAExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 266, tableId = 15, name = "templateImageId",
...
SET tableId = 16, name = "_mops_Config",
	...
	INSERT INTO md_Column
	SET columnId = 267, tableId = 16, name = "configId",
	...
	INSERT INTO md_Column
	SET columnId = 268, tableId = 16, name = "configText",
...
SET tableId = 17, name = "_mops_EonQueue",
	...
	INSERT INTO md_Column
	SET columnId = 269, tableId = 17, name = "movingObjectId",
		description = "Referring derived object",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 270, tableId = 17, name = "eventId",
	...
	INSERT INTO md_Column
	SET columnId = 271, tableId = 17, name = "insertTime",
	...
	INSERT INTO md_Column
	SET columnId = 272, tableId = 17, name = "status",
...
SET tableId = 18, name = "_mops_MoidQueue",
	...
	INSERT INTO md_Column
	SET columnId = 273, tableId = 18, name = "movingObjectId",
		description = "Referring derived object",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 274, tableId = 18, name = "movingObjectVersion",
	...
	INSERT INTO md_Column
	SET columnId = 275, tableId = 18, name = "eventId",
		description = "Referring history event causing insertion",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 3;
	...
	INSERT INTO md_Column
	SET columnId = 276, tableId = 18, name = "insertTime",
		description = "Wall clock time object was queued",
		type = "TIMESTAMP",
		notNull = 1,
...
SET tableId = 19, name = "_tmpl_Id",
	...
	INSERT INTO md_Column
	SET columnId = 277, tableId = 19, name = "id",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
...
SET tableId = 20, name = "_tmpl_IdPair",
	...
	INSERT INTO md_Column
	SET columnId = 278, tableId = 20, name = "first",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 279, tableId = 20, name = "second",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 2;
...
SET tableId = 21, name = "_tmpl_MatchPair",
	...
	INSERT INTO md_Column
	SET columnId = 280, tableId = 21, name = "first",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 281, tableId = 21, name = "second",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 2;

	INSERT INTO md_Column
	SET columnId = 282, tableId = 21, name = "distance",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 3;
...
SET tableId = 22, name = "_tmpl_mops_Ephemeris",
	...
	INSERT INTO md_Column
	SET columnId = 283, tableId = 22, name = "movingObjectId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 284, tableId = 22, name = "movingObjectVersion",
		type = "INTEGER",
		notNull = 1,
		displayOrder = 2;

	INSERT INTO md_Column
	SET columnId = 285, tableId = 22, name = "ra",
		type = "DOUBLE",
		notNull = 1,
		unit = "degree",
		displayOrder = 3;
	...
	INSERT INTO md_Column
	SET columnId = 286, tableId = 22, name = "decl",
		type = "DOUBLE",
		notNull = 1,
		unit = "degree",
		displayOrder = 4;
	...
	INSERT INTO md_Column
	SET columnId = 287, tableId = 22, name = "mjd",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 5;

	INSERT INTO md_Column
	SET columnId = 288, tableId = 22, name = "smia",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 6;

	INSERT INTO md_Column
	SET columnId = 289, tableId = 22, name = "smaa",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 7;

	INSERT INTO md_Column
	SET columnId = 290, tableId = 22, name = "pa",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 8;

	INSERT INTO md_Column
	SET columnId = 291, tableId = 22, name = "mag",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 9;
...
SET tableId = 23, name = "_tmpl_mops_Prediction",
	...
	INSERT INTO md_Column
	SET columnId = 292, tableId = 23, name = "movingObjectId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 293, tableId = 23, name = "movingObjectVersion",
		type = "INTEGER",
		notNull = 1,
		displayOrder = 2;

	INSERT INTO md_Column
	SET columnId = 294, tableId = 23, name = "ra",
		type = "DOUBLE",
		notNull = 1,
		unit = "degree",
		displayOrder = 3;
	...
	INSERT INTO md_Column
	SET columnId = 295, tableId = 23, name = "decl",
		type = "DOUBLE",
		notNull = 1,
		unit = "degree",
		displayOrder = 4;
	...
	INSERT INTO md_Column
	SET columnId = 296, tableId = 23, name = "mjd",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 5;

	INSERT INTO md_Column
	SET columnId = 297, tableId = 23, name = "smia",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 6;

	INSERT INTO md_Column
	SET columnId = 298, tableId = 23, name = "smaa",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 7;

	INSERT INTO md_Column
	SET columnId = 299, tableId = 23, name = "pa",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 8;

	INSERT INTO md_Column
	SET columnId = 300, tableId = 23, name = "mag",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 9;

	INSERT INTO md_Column
	SET columnId = 301, tableId = 23, name = "magErr",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 10;
...
SET tableId = 24, name = "mops_Event";
	...
	INSERT INTO md_Column
	SET columnId = 302, tableId = 24, name = "eventId",
	...
	INSERT INTO md_Column
	SET columnId = 303, tableId = 24, name = "procHistoryId",
	...
	INSERT INTO md_Column
	SET columnId = 304, tableId = 24, name = "eventType",
	...
	INSERT INTO md_Column
	SET columnId = 305, tableId = 24, name = "eventTime",
	...
	INSERT INTO md_Column
	SET columnId = 306, tableId = 24, name = "movingObjectId",
	...
	INSERT INTO md_Column
	SET columnId = 307, tableId = 24, name = "movingObjectVersion",
	...
	INSERT INTO md_Column
	SET columnId = 308, tableId = 24, name = "orbitCode",
	...
	INSERT INTO md_Column
	SET columnId = 309, tableId = 24, name = "d3",
	...
	INSERT INTO md_Column
	SET columnId = 310, tableId = 24, name = "d4",
	...
	INSERT INTO md_Column
	SET columnId = 311, tableId = 24, name = "ccdExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 312, tableId = 24, name = "classification",
	...
	INSERT INTO md_Column
	SET columnId = 313, tableId = 24, name = "ssmId",
...
SET tableId = 25, name = "mops_Event_OrbitDerivation",
	...
	INSERT INTO md_Column
	SET columnId = 314, tableId = 25, name = "eventId",
	...
	INSERT INTO md_Column
	SET columnId = 315, tableId = 25, name = "trackletId",
...
SET tableId = 26, name = "mops_Event_OrbitIdentification",
	...
	INSERT INTO md_Column
	SET columnId = 316, tableId = 26, name = "eventId",
		description = "Parent event ID (from mops_History table)",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 317, tableId = 26, name = "childObjectId",
...
SET tableId = 27, name = "mops_Event_TrackletAttribution",
	...
	INSERT INTO md_Column
	SET columnId = 318, tableId = 27, name = "eventId",
		description = "Parent event ID (from mops_History table)",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 319, tableId = 27, name = "trackletId",
	...
	INSERT INTO md_Column
	SET columnId = 320, tableId = 27, name = "ephemerisDistance",
	...
	INSERT INTO md_Column
	SET columnId = 321, tableId = 27, name = "ephemerisUncertainty",
...
SET tableId = 28, name = "mops_Event_TrackletPrecovery",
	...
	INSERT INTO md_Column
	SET columnId = 322, tableId = 28, name = "eventId",
		description = "Parent event ID (from mops_History table)",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 323, tableId = 28, name = "trackletId",
	...
	INSERT INTO md_Column
	SET columnId = 324, tableId = 28, name = "ephemerisDistance",
		description = "Predicted position minus actual, arcsecs",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 3;
	...
	INSERT INTO md_Column
	SET columnId = 325, tableId = 28, name = "ephemerisUncertainty",
		description = "Predicted error ellipse semi-major axis, arcsecs",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 4;
...
SET tableId = 29, name = "mops_Event_TrackletRemoval",
	...
	INSERT INTO md_Column
	SET columnId = 326, tableId = 29, name = "eventId",
		description = "Parent event ID (from mops_History table)",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 327, tableId = 29, name = "trackletId",
...
SET tableId = 30, name = "mops_MovingObject2Tracklet",
	...
	INSERT INTO md_Column
	SET columnId = 328, tableId = 30, name = "movingObjectId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 329, tableId = 30, name = "trackletId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 2;
...
SET tableId = 31, name = "mops_SSM",
	...
	INSERT INTO md_Column
	SET columnId = 330, tableId = 31, name = "ssmId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 331, tableId = 31, name = "ssmDescId",
	...
	INSERT INTO md_Column
	SET columnId = 332, tableId = 31, name = "q",
	...
	INSERT INTO md_Column
	SET columnId = 333, tableId = 31, name = "e",
		description = "eccentricity e (dimensionless)",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 4;
	...
	INSERT INTO md_Column
	SET columnId = 334, tableId = 31, name = "i",
	...
	INSERT INTO md_Column
	SET columnId = 335, tableId = 31, name = "node",
	...
	INSERT INTO md_Column
	SET columnId = 336, tableId = 31, name = "argPeri",
	...
	INSERT INTO md_Column
	SET columnId = 337, tableId = 31, name = "timePeri",
	...
	INSERT INTO md_Column
	SET columnId = 338, tableId = 31, name = "epoch",
		description = "epoch of osculating elements, MJD (UTC)",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 9;
	...
	INSERT INTO md_Column
	SET columnId = 339, tableId = 31, name = "h_v",
		description = "Absolute magnitude",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 10;
	...
	INSERT INTO md_Column
	SET columnId = 340, tableId = 31, name = "h_ss",
		description = "??",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 11;
	...
	INSERT INTO md_Column
	SET columnId = 341, tableId = 31, name = "g",
	...
	INSERT INTO md_Column
	SET columnId = 342, tableId = 31, name = "albedo",
		description = "Albedo, dimensionless",
		type = "DOUBLE",
		notNull = 0,
		unit = "-",
	...
	INSERT INTO md_Column
	SET columnId = 343, tableId = 31, name = "ssmObjectName",
...
SET tableId = 32, name = "mops_SSMDesc",
	...
	INSERT INTO md_Column
	SET columnId = 344, tableId = 32, name = "ssmDescId",
	...
	INSERT INTO md_Column
	SET columnId = 345, tableId = 32, name = "prefix",
	...
	INSERT INTO md_Column
	SET columnId = 346, tableId = 32, name = "description",
...
SET tableId = 33, name = "mops_Tracklet";
	...
	INSERT INTO md_Column
	SET columnId = 347, tableId = 33, name = "trackletId",
	...
	INSERT INTO md_Column
	SET columnId = 348, tableId = 33, name = "ccdExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 349, tableId = 33, name = "procHistoryId",
		description = "Pointer to processing history (prv_ProcHistory)",
		type = "INT",
		notNull = 1,
		displayOrder = 3;
	...
	INSERT INTO md_Column
	SET columnId = 350, tableId = 33, name = "ssmId",
		description = "Matching SSM ID for clean classifications",
		type = "BIGINT",
		notNull = 0,
		displayOrder = 4;
	...
	INSERT INTO md_Column
	SET columnId = 351, tableId = 33, name = "velRa",
	...
	INSERT INTO md_Column
	SET columnId = 352, tableId = 33, name = "velRaErr",
	...
	INSERT INTO md_Column
	SET columnId = 353, tableId = 33, name = "velDecl",
	...
	INSERT INTO md_Column
	SET columnId = 354, tableId = 33, name = "velDeclErr",
	...
	INSERT INTO md_Column
	SET columnId = 355, tableId = 33, name = "velTot",
	...
	INSERT INTO md_Column
	SET columnId = 356, tableId = 33, name = "accRa",
	...
	INSERT INTO md_Column
	SET columnId = 357, tableId = 33, name = "accRaErr",
	...
	INSERT INTO md_Column
	SET columnId = 358, tableId = 33, name = "accDecl",
	...
	INSERT INTO md_Column
	SET columnId = 359, tableId = 33, name = "accDeclErr",
	...
	INSERT INTO md_Column
	SET columnId = 360, tableId = 33, name = "extEpoch",
	...
	INSERT INTO md_Column
	SET columnId = 361, tableId = 33, name = "extRa",
	...
	INSERT INTO md_Column
	SET columnId = 362, tableId = 33, name = "extRaErr",
	...
	INSERT INTO md_Column
	SET columnId = 363, tableId = 33, name = "extDecl",
	...
	INSERT INTO md_Column
	SET columnId = 364, tableId = 33, name = "extDeclErr",
	...
	INSERT INTO md_Column
	SET columnId = 365, tableId = 33, name = "extMag",
	...
	INSERT INTO md_Column
	SET columnId = 366, tableId = 33, name = "extMagErr",
	...
	INSERT INTO md_Column
	SET columnId = 367, tableId = 33, name = "probability",
	...
	INSERT INTO md_Column
	SET columnId = 368, tableId = 33, name = "status",
	...
	INSERT INTO md_Column
	SET columnId = 369, tableId = 33, name = "classification",
...
SET tableId = 34, name = "mops_Tracklets2DIASource",
	...
	INSERT INTO md_Column
	SET columnId = 370, tableId = 34, name = "trackletId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 371, tableId = 34, name = "diaSourceId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 2;
...
SET tableId = 35, name = "prv_Filter",
	...
	INSERT INTO md_Column
	SET columnId = 372, tableId = 35, name = "filterId",
		description = "Unique id.",
		type = "TINYINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 373, tableId = 35, name = "focalPlaneId",
	...
	INSERT INTO md_Column
	SET columnId = 374, tableId = 35, name = "name",
	...
	INSERT INTO md_Column
	SET columnId = 375, tableId = 35, name = "url",
	...
	INSERT INTO md_Column
	SET columnId = 376, tableId = 35, name = "clam",
	...
	INSERT INTO md_Column
	SET columnId = 377, tableId = 35, name = "bw",
