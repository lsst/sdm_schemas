...
SET tableId = 9, name = "Science_CCD_Exposure";
	...
	SET columnId = 304, tableId = 9, name = "ccdDetectorId",
		description = "points to detector information",
		type = "INTEGER",
		notNull = 0,
		displayOrder = 4;
	...
	INSERT INTO md_Column
	SET columnId = 320, tableId = 9, name = "photoFlam",
	...
	INSERT INTO md_Column
	SET columnId = 321, tableId = 9, name = "photoZP",
	...
	INSERT INTO md_Column
	SET columnId = 322, tableId = 9, name = "nCombine",
...
SET tableId = 10, name = "Science_FPA_Exposure";
	...
	INSERT INTO md_Column
	SET columnId = 323, tableId = 10, name = "scienceFPAExposureId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
...
SET tableId = 11, name = "Visit",
	...
	INSERT INTO md_Column
	SET columnId = 324, tableId = 11, name = "visitId",
		description = "Unique id.",
		type = "INTEGER",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 325, tableId = 11, name = "exposureId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 2;
...
SET tableId = 12, name = "_MovingObject2Type",
	...
	INSERT INTO md_Column
	SET columnId = 326, tableId = 12, name = "movingObjectId",
	...
	INSERT INTO md_Column
	SET columnId = 327, tableId = 12, name = "typeId",
	...
	INSERT INTO md_Column
	SET columnId = 328, tableId = 12, name = "probability",
...
SET tableId = 13, name = "_Object2Type",
	...
	INSERT INTO md_Column
	SET columnId = 329, tableId = 13, name = "objectId",
	...
	INSERT INTO md_Column
	SET columnId = 330, tableId = 13, name = "typeId",
	...
	INSERT INTO md_Column
	SET columnId = 331, tableId = 13, name = "probability",
...
SET tableId = 14, name = "_Raw_FPA_Exposure2Visit",
	...
	INSERT INTO md_Column
	SET columnId = 332, tableId = 14, name = "visitId",
	...
	INSERT INTO md_Column
	SET columnId = 333, tableId = 14, name = "exposureId",
...
SET tableId = 15, name = "_Science_FPA_Exposure2TemplateImage",
	...
	INSERT INTO md_Column
	SET columnId = 334, tableId = 15, name = "scienceFPAExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 335, tableId = 15, name = "templateImageId",
...
SET tableId = 16, name = "_mops_Config",
	...
	INSERT INTO md_Column
	SET columnId = 336, tableId = 16, name = "configId",
	...
	INSERT INTO md_Column
	SET columnId = 337, tableId = 16, name = "configText",
...
SET tableId = 17, name = "_mops_EonQueue",
	...
	INSERT INTO md_Column
	SET columnId = 338, tableId = 17, name = "movingObjectId",
		description = "Referring derived object",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 339, tableId = 17, name = "eventId",
	...
	INSERT INTO md_Column
	SET columnId = 340, tableId = 17, name = "insertTime",
	...
	INSERT INTO md_Column
	SET columnId = 341, tableId = 17, name = "status",
...
SET tableId = 18, name = "_mops_MoidQueue",
	...
	INSERT INTO md_Column
	SET columnId = 342, tableId = 18, name = "movingObjectId",
		description = "Referring derived object",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 343, tableId = 18, name = "movingObjectVersion",
	...
	INSERT INTO md_Column
	SET columnId = 344, tableId = 18, name = "eventId",
		description = "Referring history event causing insertion",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 3;
	...
	INSERT INTO md_Column
	SET columnId = 345, tableId = 18, name = "insertTime",
		description = "Wall clock time object was queued",
		type = "TIMESTAMP",
		notNull = 1,
...
SET tableId = 19, name = "_tmpl_Id",
	...
	INSERT INTO md_Column
	SET columnId = 346, tableId = 19, name = "id",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
...
SET tableId = 20, name = "_tmpl_IdPair",
	...
	INSERT INTO md_Column
	SET columnId = 347, tableId = 20, name = "first",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 348, tableId = 20, name = "second",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 2;
...
SET tableId = 21, name = "_tmpl_MatchPair",
	...
	INSERT INTO md_Column
	SET columnId = 349, tableId = 21, name = "first",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 350, tableId = 21, name = "second",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 2;

	INSERT INTO md_Column
	SET columnId = 351, tableId = 21, name = "distance",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 3;
...
SET tableId = 22, name = "_tmpl_mops_Ephemeris",
	...
	INSERT INTO md_Column
	SET columnId = 352, tableId = 22, name = "movingObjectId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 353, tableId = 22, name = "movingObjectVersion",
		type = "INTEGER",
		notNull = 1,
		displayOrder = 2;

	INSERT INTO md_Column
	SET columnId = 354, tableId = 22, name = "ra",
		type = "DOUBLE",
		notNull = 1,
		unit = "degree",
		displayOrder = 3;
	...
	INSERT INTO md_Column
	SET columnId = 355, tableId = 22, name = "decl",
		type = "DOUBLE",
		notNull = 1,
		unit = "degree",
		displayOrder = 4;
	...
	INSERT INTO md_Column
	SET columnId = 356, tableId = 22, name = "mjd",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 5;

	INSERT INTO md_Column
	SET columnId = 357, tableId = 22, name = "smia",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 6;

	INSERT INTO md_Column
	SET columnId = 358, tableId = 22, name = "smaa",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 7;

	INSERT INTO md_Column
	SET columnId = 359, tableId = 22, name = "pa",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 8;

	INSERT INTO md_Column
	SET columnId = 360, tableId = 22, name = "mag",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 9;
...
SET tableId = 23, name = "_tmpl_mops_Prediction",
	...
	INSERT INTO md_Column
	SET columnId = 361, tableId = 23, name = "movingObjectId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 362, tableId = 23, name = "movingObjectVersion",
		type = "INTEGER",
		notNull = 1,
		displayOrder = 2;

	INSERT INTO md_Column
	SET columnId = 363, tableId = 23, name = "ra",
		type = "DOUBLE",
		notNull = 1,
		unit = "degree",
		displayOrder = 3;
	...
	INSERT INTO md_Column
	SET columnId = 364, tableId = 23, name = "decl",
		type = "DOUBLE",
		notNull = 1,
		unit = "degree",
		displayOrder = 4;
	...
	INSERT INTO md_Column
	SET columnId = 365, tableId = 23, name = "mjd",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 5;

	INSERT INTO md_Column
	SET columnId = 366, tableId = 23, name = "smia",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 6;

	INSERT INTO md_Column
	SET columnId = 367, tableId = 23, name = "smaa",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 7;

	INSERT INTO md_Column
	SET columnId = 368, tableId = 23, name = "pa",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 8;

	INSERT INTO md_Column
	SET columnId = 369, tableId = 23, name = "mag",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 9;

	INSERT INTO md_Column
	SET columnId = 370, tableId = 23, name = "magErr",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 10;
...
SET tableId = 24, name = "mops_Event";
	...
	INSERT INTO md_Column
	SET columnId = 371, tableId = 24, name = "eventId",
	...
	INSERT INTO md_Column
	SET columnId = 372, tableId = 24, name = "procHistoryId",
	...
	INSERT INTO md_Column
	SET columnId = 373, tableId = 24, name = "eventType",
	...
	INSERT INTO md_Column
	SET columnId = 374, tableId = 24, name = "eventTime",
	...
	INSERT INTO md_Column
	SET columnId = 375, tableId = 24, name = "movingObjectId",
	...
	INSERT INTO md_Column
	SET columnId = 376, tableId = 24, name = "movingObjectVersion",
	...
	INSERT INTO md_Column
	SET columnId = 377, tableId = 24, name = "orbitCode",
	...
	INSERT INTO md_Column
	SET columnId = 378, tableId = 24, name = "d3",
	...
	INSERT INTO md_Column
	SET columnId = 379, tableId = 24, name = "d4",
	...
	INSERT INTO md_Column
	SET columnId = 380, tableId = 24, name = "ccdExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 381, tableId = 24, name = "classification",
	...
	INSERT INTO md_Column
	SET columnId = 382, tableId = 24, name = "ssmId",
...
SET tableId = 25, name = "mops_Event_OrbitDerivation",
	...
	INSERT INTO md_Column
	SET columnId = 383, tableId = 25, name = "eventId",
	...
	INSERT INTO md_Column
	SET columnId = 384, tableId = 25, name = "trackletId",
...
SET tableId = 26, name = "mops_Event_OrbitIdentification",
	...
	INSERT INTO md_Column
	SET columnId = 385, tableId = 26, name = "eventId",
		description = "Parent event ID (from mops_History table)",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 386, tableId = 26, name = "childObjectId",
...
SET tableId = 27, name = "mops_Event_TrackletAttribution",
	...
	INSERT INTO md_Column
	SET columnId = 387, tableId = 27, name = "eventId",
		description = "Parent event ID (from mops_History table)",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 388, tableId = 27, name = "trackletId",
	...
	INSERT INTO md_Column
	SET columnId = 389, tableId = 27, name = "ephemerisDistance",
	...
	INSERT INTO md_Column
	SET columnId = 390, tableId = 27, name = "ephemerisUncertainty",
...
SET tableId = 28, name = "mops_Event_TrackletPrecovery",
	...
	INSERT INTO md_Column
	SET columnId = 391, tableId = 28, name = "eventId",
		description = "Parent event ID (from mops_History table)",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 392, tableId = 28, name = "trackletId",
	...
	INSERT INTO md_Column
	SET columnId = 393, tableId = 28, name = "ephemerisDistance",
		description = "Predicted position minus actual, arcsecs",
		type = "FLOAT",
		notNull = 1,
		displayOrder = 3;
	...
	INSERT INTO md_Column
	SET columnId = 394, tableId = 28, name = "ephemerisUncertainty",
		description = "Predicted error ellipse semi-major axis, arcsecs",
		type = "FLOAT",
		notNull = 0,
		displayOrder = 4;
...
SET tableId = 29, name = "mops_Event_TrackletRemoval",
	...
	INSERT INTO md_Column
	SET columnId = 395, tableId = 29, name = "eventId",
		description = "Parent event ID (from mops_History table)",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 396, tableId = 29, name = "trackletId",
...
SET tableId = 30, name = "mops_MovingObject2Tracklet",
	...
	INSERT INTO md_Column
	SET columnId = 397, tableId = 30, name = "movingObjectId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 398, tableId = 30, name = "trackletId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 2;
...
SET tableId = 31, name = "mops_SSM",
	...
	INSERT INTO md_Column
	SET columnId = 399, tableId = 31, name = "ssmId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 400, tableId = 31, name = "ssmDescId",
	...
	INSERT INTO md_Column
	SET columnId = 401, tableId = 31, name = "q",
	...
	INSERT INTO md_Column
	SET columnId = 402, tableId = 31, name = "e",
		description = "eccentricity e (dimensionless)",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 4;
	...
	INSERT INTO md_Column
	SET columnId = 403, tableId = 31, name = "i",
	...
	INSERT INTO md_Column
	SET columnId = 404, tableId = 31, name = "node",
	...
	INSERT INTO md_Column
	SET columnId = 405, tableId = 31, name = "argPeri",
	...
	INSERT INTO md_Column
	SET columnId = 406, tableId = 31, name = "timePeri",
	...
	INSERT INTO md_Column
	SET columnId = 407, tableId = 31, name = "epoch",
		description = "epoch of osculating elements, MJD (UTC)",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 9;
	...
	INSERT INTO md_Column
	SET columnId = 408, tableId = 31, name = "h_v",
		description = "Absolute magnitude",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 10;
	...
	INSERT INTO md_Column
	SET columnId = 409, tableId = 31, name = "h_ss",
		description = "??",
		type = "DOUBLE",
		notNull = 0,
		displayOrder = 11;
	...
	INSERT INTO md_Column
	SET columnId = 410, tableId = 31, name = "g",
	...
	INSERT INTO md_Column
	SET columnId = 411, tableId = 31, name = "albedo",
		description = "Albedo, dimensionless",
		type = "DOUBLE",
		notNull = 0,
		unit = "-",
	...
	INSERT INTO md_Column
	SET columnId = 412, tableId = 31, name = "ssmObjectName",
...
SET tableId = 32, name = "mops_SSMDesc",
	...
	INSERT INTO md_Column
	SET columnId = 413, tableId = 32, name = "ssmDescId",
	...
	INSERT INTO md_Column
	SET columnId = 414, tableId = 32, name = "prefix",
	...
	INSERT INTO md_Column
	SET columnId = 415, tableId = 32, name = "description",
...
SET tableId = 33, name = "mops_Tracklet";
	...
	INSERT INTO md_Column
	SET columnId = 416, tableId = 33, name = "trackletId",
	...
	INSERT INTO md_Column
	SET columnId = 417, tableId = 33, name = "ccdExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 418, tableId = 33, name = "procHistoryId",
		description = "Pointer to processing history (prv_ProcHistory)",
		type = "INT",
		notNull = 1,
		displayOrder = 3;
	...
	INSERT INTO md_Column
	SET columnId = 419, tableId = 33, name = "ssmId",
		description = "Matching SSM ID for clean classifications",
		type = "BIGINT",
		notNull = 0,
		displayOrder = 4;
	...
	INSERT INTO md_Column
	SET columnId = 420, tableId = 33, name = "velRa",
	...
	INSERT INTO md_Column
	SET columnId = 421, tableId = 33, name = "velRaErr",
	...
	INSERT INTO md_Column
	SET columnId = 422, tableId = 33, name = "velDecl",
	...
	INSERT INTO md_Column
	SET columnId = 423, tableId = 33, name = "velDeclErr",
	...
	INSERT INTO md_Column
	SET columnId = 424, tableId = 33, name = "velTot",
	...
	INSERT INTO md_Column
	SET columnId = 425, tableId = 33, name = "accRa",
	...
	INSERT INTO md_Column
	SET columnId = 426, tableId = 33, name = "accRaErr",
	...
	INSERT INTO md_Column
	SET columnId = 427, tableId = 33, name = "accDecl",
	...
	INSERT INTO md_Column
	SET columnId = 428, tableId = 33, name = "accDeclErr",
	...
	INSERT INTO md_Column
	SET columnId = 429, tableId = 33, name = "extEpoch",
	...
	INSERT INTO md_Column
	SET columnId = 430, tableId = 33, name = "extRa",
	...
	INSERT INTO md_Column
	SET columnId = 431, tableId = 33, name = "extRaErr",
	...
	INSERT INTO md_Column
	SET columnId = 432, tableId = 33, name = "extDecl",
	...
	INSERT INTO md_Column
	SET columnId = 433, tableId = 33, name = "extDeclErr",
	...
	INSERT INTO md_Column
	SET columnId = 434, tableId = 33, name = "extMag",
	...
	INSERT INTO md_Column
	SET columnId = 435, tableId = 33, name = "extMagErr",
	...
	INSERT INTO md_Column
	SET columnId = 436, tableId = 33, name = "probability",
	...
	INSERT INTO md_Column
	SET columnId = 437, tableId = 33, name = "status",
	...
	INSERT INTO md_Column
	SET columnId = 438, tableId = 33, name = "classification",
...
SET tableId = 34, name = "mops_Tracklets2DIASource",
	...
	INSERT INTO md_Column
	SET columnId = 439, tableId = 34, name = "trackletId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 440, tableId = 34, name = "diaSourceId",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 2;
...
SET tableId = 35, name = "prv_PolicyFile";
	...
	INSERT INTO md_Column
	SET columnId = 441, tableId = 35, name = "policyFileId",
		type = "INTEGER",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 442, tableId = 35, name = "pathName",
		type = "VARCHAR(255)",
		notNull = 1,
		displayOrder = 2;

	INSERT INTO md_Column
	SET columnId = 443, tableId = 35, name = "hashValue",
		type = "CHAR(32)",
		notNull = 1,
		displayOrder = 3;

	INSERT INTO md_Column
	SET columnId = 444, tableId = 35, name = "modifiedDate",
		type = "DATETIME",
		notNull = 1,
		displayOrder = 4;
...
SET tableId = 36, name = "prv_PolicyKey";
	...
	INSERT INTO md_Column
	SET columnId = 445, tableId = 36, name = "policyKeyId",
		type = "INTEGER",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 446, tableId = 36, name = "policyFileId",
		type = "INTEGER",
		notNull = 1,
		displayOrder = 2;

	INSERT INTO md_Column
	SET columnId = 447, tableId = 36, name = "keyName",
		type = "VARCHAR(255)",
		notNull = 1,
		displayOrder = 3;
...
SET tableId = 37, name = "prv_SoftwarePackage";
	...
	INSERT INTO md_Column
	SET columnId = 448, tableId = 37, name = "packageId",
		type = "INTEGER",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 449, tableId = 37, name = "packageName",
		type = "VARCHAR(64)",
		notNull = 1,
		displayOrder = 2;
...
SET tableId = 38, name = "prv_cnf_PolicyKey";
	...
	INSERT INTO md_Column
	SET columnId = 450, tableId = 38, name = "policyKeyId",
		type = "INTEGER",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 451, tableId = 38, name = "value",
		type = "VARCHAR(255)",
		notNull = 1,
		displayOrder = 2;

	INSERT INTO md_Column
	SET columnId = 452, tableId = 38, name = "validityBegin",
		type = "DATETIME",
		notNull = 0,
		displayOrder = 3;

	INSERT INTO md_Column
	SET columnId = 453, tableId = 38, name = "validityEnd",
		type = "DATETIME",
		notNull = 0,
		displayOrder = 4;
...
SET tableId = 39, name = "prv_cnf_SoftwarePackage";
	...
	INSERT INTO md_Column
	SET columnId = 454, tableId = 39, name = "packageId",
		type = "INTEGER",
		notNull = 1,
		displayOrder = 1;

	INSERT INTO md_Column
	SET columnId = 455, tableId = 39, name = "version",
		type = "VARCHAR(32)",
		notNull = 1,
		displayOrder = 2;

	INSERT INTO md_Column
	SET columnId = 456, tableId = 39, name = "directory",
		type = "VARCHAR(255)",
		notNull = 1,
		displayOrder = 3;

	INSERT INTO md_Column
	SET columnId = 457, tableId = 39, name = "validityBegin",
		type = "DATETIME",
		notNull = 0,
		displayOrder = 4;

	INSERT INTO md_Column
	SET columnId = 458, tableId = 39, name = "validityEnd",
		type = "DATETIME",
		notNull = 0,
		displayOrder = 5;
...
SET tableId = 40, name = "sdqa_ImageStatus",
	...
	INSERT INTO md_Column
	SET columnId = 459, tableId = 40, name = "sdqa_imageStatusId",
	...
	INSERT INTO md_Column
	SET columnId = 460, tableId = 40, name = "statusName",
	...
	INSERT INTO md_Column
	SET columnId = 461, tableId = 40, name = "definition",
...
SET tableId = 41, name = "sdqa_Metric",
	...
	INSERT INTO md_Column
	SET columnId = 462, tableId = 41, name = "sdqa_metricId",
		description = "Primary key.",
		type = "SMALLINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 463, tableId = 41, name = "metricName",
	...
	INSERT INTO md_Column
	SET columnId = 464, tableId = 41, name = "physicalUnits",
	...
	INSERT INTO md_Column
	SET columnId = 465, tableId = 41, name = "dataType",
	...
	INSERT INTO md_Column
	SET columnId = 466, tableId = 41, name = "definition",
		type = "VARCHAR(255)",
		notNull = 1,
		displayOrder = 5;
...
SET tableId = 42, name = "sdqa_Rating_4ScienceAmpExposure",
	...
	INSERT INTO md_Column
	SET columnId = 467, tableId = 42, name = "sdqa_ratingId",
		description = "Primary key.",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 468, tableId = 42, name = "sdqa_metricId",
	...
	INSERT INTO md_Column
	SET columnId = 469, tableId = 42, name = "sdqa_thresholdId",
	...
	INSERT INTO md_Column
	SET columnId = 470, tableId = 42, name = "ampExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 471, tableId = 42, name = "metricValue",
	...
	INSERT INTO md_Column
	SET columnId = 472, tableId = 42, name = "metricErr",
...
SET tableId = 43, name = "sdqa_Rating_4ScienceCCDExposure",
	...
	INSERT INTO md_Column
	SET columnId = 473, tableId = 43, name = "sdqa_ratingId",
		description = "Primary key.",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 474, tableId = 43, name = "sdqa_metricId",
		description = "Pointer to sdqa_Metric.",
		type = "SMALLINT",
		notNull = 1,
		displayOrder = 2;
	...
	INSERT INTO md_Column
	SET columnId = 475, tableId = 43, name = "sdqa_thresholdId",
		description = "Pointer to sdqa_Threshold.",
		type = "SMALLINT",
		notNull = 1,
		displayOrder = 3;
	...
	INSERT INTO md_Column
	SET columnId = 476, tableId = 43, name = "ccdExposureId",
	...
	INSERT INTO md_Column
	SET columnId = 477, tableId = 43, name = "metricValue",
		description = "Value of this SDQA metric.",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 5;
	...
	INSERT INTO md_Column
	SET columnId = 478, tableId = 43, name = "metricErr",
		description = "Uncertainty of the value of this metric.",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 6;
...
SET tableId = 44, name = "sdqa_Rating_4ScienceFPAExposure",
	...
	INSERT INTO md_Column
	SET columnId = 479, tableId = 44, name = "sdqa_ratingId",
		description = "Primary key.",
		type = "BIGINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 480, tableId = 44, name = "sdqa_metricId",
		description = "Pointer to sdqa_Metric.",
		type = "SMALLINT",
		notNull = 1,
		displayOrder = 2;
	...
	INSERT INTO md_Column
	SET columnId = 481, tableId = 44, name = "sdqa_thresholdId",
		description = "Pointer to sdqa_Threshold.",
		type = "SMALLINT",
		notNull = 1,
		displayOrder = 3;
	...
	INSERT INTO md_Column
	SET columnId = 482, tableId = 44, name = "exposureId",
	...
	INSERT INTO md_Column
	SET columnId = 483, tableId = 44, name = "metricValue",
		description = "Value of this SDQA metric.",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 5;
	...
	INSERT INTO md_Column
	SET columnId = 484, tableId = 44, name = "metricErr",
		description = "Uncertainty of the value of this metric.",
		type = "DOUBLE",
		notNull = 1,
		displayOrder = 6;
...
SET tableId = 45, name = "sdqa_Threshold",
	...
	INSERT INTO md_Column
	SET columnId = 485, tableId = 45, name = "sdqa_thresholdId",
		description = "Primary key.",
		type = "SMALLINT",
		notNull = 1,
		displayOrder = 1;
	...
	INSERT INTO md_Column
	SET columnId = 486, tableId = 45, name = "sdqa_metricId",
	...
	INSERT INTO md_Column
	SET columnId = 487, tableId = 45, name = "upperThreshold",
	...
	INSERT INTO md_Column
	SET columnId = 488, tableId = 45, name = "lowerThreshold",
	...
	INSERT INTO md_Column
	SET columnId = 489, tableId = 45, name = "createdDate",
