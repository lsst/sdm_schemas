...
CREATE TABLE AAA_Version_3_1_61 (version CHAR);
...
(
	...
	sky FLOAT(0) NOT NULL,
	skySigma FLOAT(0) NOT NULL,
	psfFlux FLOAT(0) NOT NULL,
	psfFluxSigma FLOAT(0) NOT NULL,
	apFlux FLOAT(0) NOT NULL,
	apFluxSigma FLOAT(0) NOT NULL,
	modelFlux FLOAT(0) NOT NULL,
	modelFluxSigma FLOAT(0) NOT NULL,
	modelFluxCanonicalBand FLOAT(0) NOT NULL,
	modelFluxCanonicalBandSigma FLOAT(0) NOT NULL,
	psfLnL FLOAT(0) NULL,
...
(
	...
	uPetroMagSigma FLOAT(0) NULL,
	uMomentIxx FLOAT(0) NULL,
	uMomentIyy FLOAT(0) NULL,
	uMomentIxy FLOAT(0) NULL,
	uNumObs INTEGER NULL,
	uFlags INTEGER NULL,
	gMag DOUBLE NULL,
	gMagSigma FLOAT(0) NULL,
	gPetroMag FLOAT(0) NULL,
	gPetroMagSigma FLOAT(0) NULL,
	gMomentIxx FLOAT(0) NULL,
	gMomentIyy FLOAT(0) NULL,
	gMomentIxy FLOAT(0) NULL,
	gNumObs INTEGER NULL,
	gFlags INTEGER NULL,
	rMag DOUBLE NULL,
	rMagSigma FLOAT(0) NULL,
	rPetroMag FLOAT(0) NULL,
	rPetroMagSigma FLOAT(0) NULL,
	rMomentIxx FLOAT(0) NULL,
	rMomentIyy FLOAT(0) NULL,
	rMomentIxy FLOAT(0) NULL,
	rNumObs INTEGER NULL,
	rFlags INTEGER NULL,
	iMag DOUBLE NULL,
	iMagSigma FLOAT(0) NULL,
	iPetroMag FLOAT(0) NULL,
	iPetroMagSigma FLOAT(0) NULL,
	iMomentIxx FLOAT(0) NULL,
	iMomentIyy FLOAT(0) NULL,
	iMomentIxy FLOAT(0) NULL,
	iNumObs INTEGER NULL,
	iFlags INTEGER NULL,
	zMag DOUBLE NULL,
	zMagSigma FLOAT(0) NULL,
	zPetroMag FLOAT(0) NULL,
	zPetroMagSigma FLOAT(0) NULL,
	zIxx FLOAT(0) NULL,
	zIyy FLOAT(0) NULL,
	zIxy FLOAT(0) NULL,
	...
	yPetroMagSigma FLOAT(0) NULL,
	yMomentIxx FLOAT(0) NULL,
	yMomentIyy FLOAT(0) NULL,
	yMomentIxy FLOAT(0) NULL,
