...
CREATE TABLE AAA_Version_DC3_3_0_2 (version CHAR);

--  -------------------------------------------------- 
--  Generated by Enterprise Architect Version 7.1.832
--  Created On : Monday, 10 November, 2008 
--  DBMS       : MySql 
--  -------------------------------------------------- 
...
(
	...
	mopsStatus CHAR(1) NULL COMMENT 'efficiency marker; indicates detection was detected (not lost in chip gap, etc.)',
...
(
	...
	mopsStatus CHAR(1) NULL COMMENT 'NULL, or set to ''M'' when DO is merged with parent',
...
(
	...
	createdDate TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Database timestamp when the record is inserted.',
...
(
	sdqa_imageStatusId SMALLINT NOT NULL COMMENT 'Primary key',
