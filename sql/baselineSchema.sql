...
CREATE TABLE Source_pt2
    -- <descr>Table to store high signal-to-noise &quot;sources&quot;. A source
    -- is a measurement of Object's properties from a single image that contains
    -- its footprint on the sky. This table is expected to be used in
    -- DC3b-pt2.&#xA;</descr>
(
    sourceId BIGINT NOT NULL,
        -- <descr>Unique id.&#xA;</descr>
    ...
    ra DOUBLE NOT NULL,
        -- <descr>RA-coordinate of the center of the source.&#xA;</descr>
        -- <unit>degree</unit>
    raSigma FLOAT(0) NOT NULL,
        -- <descr>Uncertainty of ra.&#xA;</descr>
        -- <unit>degree</unit>
    decl DOUBLE NOT NULL,
        -- <descr>Decl-coordinate of the center of the source.&#xA;</descr>
        -- <unit>degree</unit>
    declSigma FLOAT(0) NOT NULL,
        -- <descr>Uncertainty of decl.&#xA;</descr>
        -- <unit>degree</unit>
    ...
    galExtinction FLOAT(0) NULL,
        -- <descr>Galactic extinction.&#xA;</descr>
    sersicN_SG FLOAT(0) NULL,
        -- <descr>Sersic index for Small Galaxy model.&#xA;</descr>
    sersicN_SG_Sigma FLOAT(0) NULL,
        -- <descr>Uncertainty of sersicN_SG.&#xA;</descr>
    e1_SG FLOAT(0) NULL,
        -- <descr>Ellipticity for Small Galaxy model.&#xA;</descr>
    e1_SG_Sigma FLOAT(0) NULL,
        -- <descr>Uncertainty of e1_SG.&#xA;</descr>
    e2_SG FLOAT(0) NULL,
        -- <descr>Ellipticity for Small Galaxy model.&#xA;</descr>
    e2_SG_Sigma FLOAT(0) NULL,
        -- <descr>Uncertainty of e2_SG.&#xA;</descr>
    radius_SG FLOAT(0) NULL,
        -- <descr>Size of Small Galaxy model.&#xA;</descr>
    radius_SG_Sigma FLOAT(0) NULL,
        -- <descr>Uncertainty of radius_SG.&#xA;</descr>
    midPoint FLOAT(0) NOT NULL,
        -- <descr>Corrected midPoint of the exposure (tai).&#xA;</descr>
    apCorrection FLOAT(0) NOT NULL,
        -- <descr>Photometric correction: aperture correction.&#xA;</descr>
    ...
    momentIxy FLOAT(0) NULL,
        -- <descr>Adaptive second moment.&#xA;</descr>
    momentIxySigma FLOAT(0) NULL,
        -- <descr>Uncertainty of momentIxy.&#xA;</descr>
    flags BIGINT NOT NULL,
        -- <descr>Flags.&#xA;</descr>
    _chunkId INTEGER NULL,
        -- <descr>Internal column used by qserv.&#xA;</descr>
