...
which contains the results of processing from the [Alert Production Pipeline](https://github.com/lsst/ap_pipe).
...
The details of the migration process are described in the [package documentation](https://pipelines.lsst.io/modules/lsst.dax.apdb/index.html).
